...
public class PseudoRandom
{
	...
	/**
	 * Returns a number of successful events in a sample of n events each with probability p of success
	 */
	public static int randBinomial(int n, double p) 
	{
